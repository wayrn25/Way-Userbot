...
class Config(object):
    ...
    if not BLACKLIST_CHAT:
        BLACKLIST_CHAT = [-1001473548283, -1001675396283, -1002188357301]
    ...
    # Support
    GROUP = getenv("GROUP", "publicwayy")
    CHANNEL = getenv("CHANNEL", "waymethod")
    ...
    ALIVE_TEKS_CUSTOM = getenv(
        "ALIVE_TEKS_CUSTOM",
        "Hallo, Saya pengguna Way Userbot")

    # Default .alive name
    ALIVE_NAME = getenv("ALIVE_NAME", "WayMethod")
    ...
    ALIVE_LOGO = (getenv("ALIVE_LOGO")
                or "hhttps://telegra.ph/file/62a338f1a36dae5f26ada.jpg")

    INLINE_PIC = (getenv("INLINE_PIC")
                or "https://telegra.ph/file/3dc8bb352de4734f1a376.jpg")
